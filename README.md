...
Online documentation, which includes examples, can be found at: http://godoc.org/github.com/therealfakemoot/go-telnet

[![GoDoc](https://godoc.org/github.com/therealfakemoot/go-telnet?status.svg)](https://godoc.org/github.com/reiver/go-telnet)
...
A more useful TELNET servers can be made using the `"github.com/therealfakemoot/go-telnet/telsh"` sub-package.
...
import (
	...
	"github.com/therealfakemoot/go-telnet"
	"github.com/therealfakemoot/go-telnet/telsh"
...
TELNET servers made using the `"github.com/therealfakemoot/go-telnet/telsh"` sub-package will often be more useful
as it makes it easier for you to create a *shell* interface.


# More Information

There is a lot more information about documentation on all this here: http://godoc.org/github.com/therealfakemoot/go-telnet
